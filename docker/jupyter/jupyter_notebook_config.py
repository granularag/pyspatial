...
c.NotebookApp.certfile = u'/etc/jupyter/certs/jupyter.pem'
...
c.NotebookApp.keyfile = u'/etc/jupyter/certs/jupyter.key'
...
#  RECOMMENDED.
c.NotebookApp.token = 'ad51282dc392fd434789cd9f25c6b9d3d76c767963bbbb3b'
